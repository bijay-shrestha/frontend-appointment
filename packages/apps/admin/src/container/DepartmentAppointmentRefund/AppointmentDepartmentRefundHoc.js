    ...
    class AppointmentDepartmentRefundDetails extends React.PureComponent {
        ...
        callApiForHospitalChange = async hospitalId => {
            ...
            this.props.fetchPatientMetaDropdown(
                patientSetupApiConstant.ACTIVE_PATIENT_META_INFO_DETAILS, hospitalId)
        };
        ...
        handleSearchFormChange = async (event, field) => {
            if (event) {
                ...
                else if (fieldName === 'hospitalDepartmentId') {
        ...
        refundHandleApi = async () => {
            ...
            const {appointmentId, appointmentModeId, hospitalId} = refundDetail;
            let requestDTO;
            try {
        ...
        render() {
            ...
            const {hospitalsForDropdown, isAllHospitalFetchLoading} = this.props.HospitalDropdownReducer
                ...
                <>
                    <ComposedComponent
                        ...
                        searchHandler={{
                            ...
                            isAllHospitalFetchLoading: isAllHospitalFetchLoading
                        }}
                        paginationProps={{
