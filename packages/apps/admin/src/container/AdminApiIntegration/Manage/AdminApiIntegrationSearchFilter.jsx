        ...
        {this.state.isSearchFormExpanded ? (
          <div id="advanced-search" className="advanced-search">
            <div className="search-header d-flex justify-content-between">
              <h5 className="title">Search Appointment Mode API Integration</h5>
              <div>
                <CButton
                  id="reset-form"
                ...
                <Row>
                  ...
                  <Col sm={12} md={4} xl={4}>
                    <CHybridSelect
                      ...
                      label="Appointment Mode API Integration Type"
                      ...
                      placeholder={'Select Appointment Mode API Integration Type.'}
                    />
                  </Col>
                  ...
                  <Col sm={12} md={4} xl={4}>
                    <CHybridSelect
                      ...
                      placeholder={
                        !searchParams.apiIntegrationTypeId
                          ? 'Select Appointment Mode API Integration First.'
                          : featureTypeDropdownData.length
                          ? 'Select Feature Type'
              ...
              {searchParams.apiIntegrationTypeId.value && (
                <li>
                  <OverlayTrigger
                    ...
                    delay={{show: 250, hide: 400}}
                    overlay={props => (
                      <Tooltip {...props}>Appointment Mode API Integration Type</Tooltip>
                    )}
                  >
                    <Button id="light-search-filters" variant="secondary">
