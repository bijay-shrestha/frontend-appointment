...
export const ADMIN_SERVER_DOMAIN = process.env.REACT_APP_ADMIN_FRONTEND_DOMAIN_URL || '';
export const CLIENT_SERVER_DOMAIN = process.env.REACT_APP_CLIENT_FRONTEND_DOMAIN_URL || '';
