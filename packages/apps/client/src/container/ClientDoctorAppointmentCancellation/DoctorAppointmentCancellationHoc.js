...
import './doctor-appointment-cancellation.scss'
...
const DoctorAppointmentCancellationHoc = (ComposedComponent, props, type) => {
    const {
...
export default DoctorAppointmentCancellationHoc
