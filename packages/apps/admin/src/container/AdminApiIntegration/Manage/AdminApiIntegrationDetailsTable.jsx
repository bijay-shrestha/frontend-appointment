...
import {ConfirmDelete, RequestMethodStatus, StatusLabel, TableAction} from '@frontend-appointment/ui-components'
...
const ClientApiIntegrationDetailsDataTable = ({
    ...
    <div className="manage-details">
        <h5 className="title">Appointment Mode API Integration Details</h5>
        ...
        {deleteModalShow ? (
            <ConfirmDelete
                confirmationMessage="Are you sure you want to delete the Appointment Mode API Integration? If yes please provide remarks."
                modalHeader="Delete Appointment Mode API Integration"
