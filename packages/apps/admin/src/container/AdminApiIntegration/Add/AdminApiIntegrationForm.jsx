...
import {CButton, CCheckbox, CFLabel, CForm, CHybridInput, CHybridSelect} from '@frontend-appointment/ui-elements'
...
const ClientApiIntegrationForm = ({
    ...
    return (
        <>
            <Container-fluid>
                <Row sm="12 p-0">
                    <h5 className="title"> Appointment Mode API Integration </h5>
                </Row>
                            ...
                            {integrationData.integrationTypeId && integrationData.integrationTypeId.value === 1 ?
                                <Col sm={12} md={3}>
                                    <CHybridSelect
                                        ...
                                        value={integrationData.hospital}
                                        isDisabled={
                                            !hospitalList.length
                                        }
                                        placeholder={
