...
export const requestbodyIntegrationConstants = {
    ...
    REQUEST_BODY_API_INTEGRATION_SEARCH:BASE.concat(REQUEST_BODY_INTEGRATION+"/search"),
    REQUEST_BODY_API_INTEGRATION_EDIT:BASE.concat(REQUEST_BODY_INTEGRATION),
    REQUEST_BODY_API_INTEGRATION_PREVIEW:BASE.concat(REQUEST_BODY_INTEGRATION),
