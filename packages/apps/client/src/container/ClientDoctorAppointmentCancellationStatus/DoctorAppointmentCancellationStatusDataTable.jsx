...
const DoctorAppointmentCancellationStatusDataTable = ({tableHandler, paginationProps}) => {
    const {
        isSearchLoading,
    ...
    return (
        <>
            ...
            {showModal ? (
                <DoctorAppointmentCancellationStatusPreview
                    showModal={showModal}
...
export default memo(DoctorAppointmentCancellationStatusDataTable)
