...
export const fetchCompanyAdminList = (
    ...
    try {
        ...
        dispatch(CompanyAdminSetupActions.companyAdminListSuccess(dataWithPresignedUrl))
        return response
    } catch (e) {
...
export const previewCompanyAdmin = (path, id) => async dispatch => {
    ...
    try {
        ...
        dispatch(CompanyAdminSetupActions.companyAdminPreviewSuccess(dataWithFileUri))
        return response
    } catch (e) {
        dispatch(
