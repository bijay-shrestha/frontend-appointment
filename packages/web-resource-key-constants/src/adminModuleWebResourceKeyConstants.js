...
export const doctorDutyRosterApiConstants = {
    ...
    REVERT_DOCTOR_DUTY_ROSTER_OVERRIDE_UPDATE: BASE.concat(DOCTOR_DUTY_ROSTER_BASE.concat("/doctorDutyRosterOverride/revert"))
};
...
export const hospitalDepartmentSetupApiConstants = {
    ...
    FETCH_HOSPITAL_DEPARTMENT_DETAILS_BY_ID: BASE.concat(HOSPITAL_DEPARTMENT_SETUP_BASE.concat("/detail")),
    ...
    FETCH_AVAILABLE_ROOMS_FOR_DROPDOWN: BASE.concat(HOSPITAL_DEPARTMENT_SETUP_BASE.concat("/available/room")),
};
...
export const departmentDutyRosterApiConstants = {
    ...
    SEARCH_DEPARTMENT_DUTY_ROSTER: BASE.concat(DEPARTMENT_DUTY_ROSTER_BASE.concat("/search")),
    FETCH_DEPARTMENT_DUTY_ROSTER_DETAIL_BY_ID: BASE.concat(DEPARTMENT_DUTY_ROSTER_BASE.concat("/detail")),
    FETCH_EXISTING_DEPARTMENT_DUTY_ROSTER: BASE.concat(DEPARTMENT_DUTY_ROSTER_BASE.concat("/existing")),
    FETCH_EXISTING_DEPARTMENT_DUTY_ROSTER_DETAIL_BY_ID: BASE.concat(DEPARTMENT_DUTY_ROSTER_BASE.concat("/existing/detail")),
    UPDATE_DEPARTMENT_DUTY_ROSTER_OVERRIDE: BASE.concat(DEPARTMENT_DUTY_ROSTER_BASE.concat("/override")),
...
export const adminApiIntegrationConstants = {
    ...
    ADMIN_API_INTEGRATION_SEARCH:BASE.concat(ADMIN_API_INTEGRATION+"/client-api-integration"),
