        ...
        editApiCall = async () => {
            ...
            try {
                if (adminAvatarUrlNew) {
                    ...
                    imagePathLogo = await this.uploadImageToServer();
                    this.setImageLoading(false)
                }
                await this.props.editCompanyAdmin(
                    EDIT_COMPANY_ADMIN,
                    {...adminUpdateRequestDTO, avatar: imagePathLogo},
                )
                ...
                this.setState({
                    isImageUploading: false,
                    errorMessage: e.errorMessage ? e.errorMessage : "Error updating  Company Admin."
                })
            }
        }
        ...
        handleConfirmClick = async () => {
            ...
            try {
                ...
                await this.props.createCompanyAdmin(
                    CREATE_COMPANY_ADMIN,
                    {...adminRequestDTO, avatar: imagePathLogo}
                )
