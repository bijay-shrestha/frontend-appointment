...
export const fetchAppointmentStatusCountByDepartmentPending = () => {
    return {
        type: FETCH_APPOINTMENT_STATUS_COUNT_FOR_DEPARTMENT_PENDING
    }
}

export const fetchAppointmentStatusCountByDepartmentSuccess = data => {
    return {
        type: FETCH_APPOINTMENT_STATUS_COUNT_FOR_DEPARTMENT_SUCCESS,
        payload: {
            data
        }
    }
...
export const fetchAppointmentStatusCountByDepartmentError = errorMessage => {
    return {
        type: FETCH_APPOINTMENT_STATUS_COUNT_FOR_DEPARTMENT_ERROR,
        payload: {
            errorMessage
        }
    }
