...
const {
    ...
    FETCH_HOSPITALS__DROPDOWN_ERROR,
    FETCH_HOSPITALS__DROPDOWN_SUCCESS,
...
export const HospitalSetupReducer = (state = {...initialState}, action) => {
    switch (action.type) {
        case FETCH_HOSPITALS__DROPDOWN_SUCCESS:
            return {
                ...state,
                hospitalsForDropdown: [...action.payload.data]
            };
        case FETCH_HOSPITALS__DROPDOWN_ERROR:
            return {
                ...state,
                hospitalsForDropdown: []
            };
