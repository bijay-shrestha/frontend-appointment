...
class CHybridSelect extends PureComponent {
    ...
    handleOnBlur = event => {
        ReactDOM.findDOMNode(this.refs['select-label'.concat(this.props.id)]).classList.remove('active');
    };

    handleOnFocus = event => {
        ReactDOM.findDOMNode(this.refs['select-label'.concat(this.props.id)]).classList.add('active');
    };

    handleOnChange = event => {
        event ? this.props.onChange({target: {name: this.props.name, value: event.value, label: event.label}})
            : this.props.onChange({target: {name: this.props.name, value: '', label: ''}});
    };
