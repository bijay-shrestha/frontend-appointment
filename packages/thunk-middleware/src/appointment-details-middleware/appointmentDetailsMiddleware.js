...
export const fetchAppointmentApprovalList = (path,pagination,data) => async dispatch => {
    dispatch(AppointmentDetailActions.appointmentApprovalFetchingStart());
    try {
        const response = await Axios.putWithPagination(path,pagination,data);
        dispatch(AppointmentDetailActions.appointmentApprovalFetchingSuccess(response.data));
    } catch (e) {
        dispatch(AppointmentDetailActions.appointmentApprovalFetchingError(e.errorMessage||"Sorry Internal Server Problem"));
    }
};
...
export const fetchAppointmentLogList = (path,pagination,data) => async dispatch => {
    dispatch(AppointmentDetailActions.appointmentLogFetchingStart());
    try {
        const response = await Axios.putWithPagination(path,pagination,data);
        dispatch(AppointmentDetailActions.appointmentLogFetchingSuccess(response.data));
    } catch (e) {
        dispatch(AppointmentDetailActions.appointmentLogFetchingError(e.errorMessage||"Sorry Internal Server Problem"));
    }
};
...
export const fetchAppointmentStatusList = (path,pagination,data) => async dispatch => {
