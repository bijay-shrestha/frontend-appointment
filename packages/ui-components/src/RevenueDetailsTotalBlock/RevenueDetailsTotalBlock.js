            ...
            <div className="row rd-container">
                <Col md={4} className="p-0  mt-4">
                    <div className="rd-card book">
                        ...
                        <div className="rd-content ">
                            ...
                            <div> <span
                                className="amt"> NPR {appointmentStatistics.bookedInfo
                            && appointmentStatistics.bookedInfo.bookedAmount || 0}</span> from<span
                                className="apt">  {appointmentStatistics.bookedInfo
                            && appointmentStatistics.bookedInfo.bookedCount || 0} </span>Appt.
                            </div>
                            {appointmentStatistics.bookedInfo &&
                            appointmentStatistics.bookedInfo.followUpCount ?
                                <div className="follow-up"><i className="fa fa-tag"/><span
                                    className="fl-label"> Follow-up </span> <span
                                    className="amt"> NPR {appointmentStatistics.bookedInfo
                                && appointmentStatistics.bookedInfo.followUpAmount || 0}</span> from<span
                                    className="apt"> {appointmentStatistics.bookedInfo
                                && appointmentStatistics.bookedInfo.followUpCount || 0} </span>Appt.
                                </div> : ""
                            }
                ...
                <Col md={4} className="p-0  mt-4">
                    <div className="rd-card checkin">
                        ...
                        <div className="rd-content ">
                            ...
                            <div> <span
                                className="amt"> NPR {appointmentStatistics.checkedInInfo
                            && appointmentStatistics.checkedInInfo.checkedInAmount || 0}</span> from<span
                                className="apt"> {appointmentStatistics.checkedInInfo
                            && appointmentStatistics.checkedInInfo.checkedInCount || 0} </span>Appt.
                            </div>
                            {appointmentStatistics.checkedInInfo &&
                            appointmentStatistics.checkedInInfo.followUpCount ?
                                <div className="follow-up"><i className="fa fa-tag"></i><span
                                    className="fl-label"> Follow-up </span> <span
                                    className="amt"> NPR {appointmentStatistics.checkedInInfo
                                && appointmentStatistics.checkedInInfo.followUpAmount || 0}</span> from<span
                                    className="apt"> {appointmentStatistics.checkedInInfo
                                && appointmentStatistics.checkedInInfo.followUpCount || 0} </span>Appt.
                                </div> : ""
                            }
                        </div>
                    </div>
                ...
                <Col md={4} className="p-0  mt-4">
                    <div className="rd-card cancel">
                        ...
                        <div className="rd-content ">
                            <div><span className="label">Cancelled</span></div>
                            <div> <span
                ...
                <Col md={4} className="p-0  mt-4">
                    <div className="rd-card refund">
                        ...
                        <div className="rd-content ">
                            <div><span className="label">Refunded</span></div>
                            <div> <span
                                className="amt"> NPR {appointmentStatistics.revenueFromRefundInfo &&
                            appointmentStatistics.revenueFromRefundInfo.revenueFromRefundAmount || 0}</span> from
                                <span
                                    className="apt">  {appointmentStatistics.revenueFromRefundInfo &&
                                appointmentStatistics.revenueFromRefundInfo.revenueFromRefundCount || 0} </span>Appt.
                            </div>
                            ...
                            appointmentStatistics.revenueFromRefundInfo.followUpCount ?
                                <div className="follow-up"><i className="fa fa-tag"></i><span
                                    className="fl-label"> Follow-up </span> <span
                                    className="amt"> NPR {appointmentStatistics.revenueFromRefundInfo
                                && appointmentStatistics.revenueFromRefundInfo.followUpAmount || 0}</span> from<span
                                    className="apt"> {appointmentStatistics.revenueFromRefundInfo
                                && appointmentStatistics.revenueFromRefundInfo.followUpCount || 0} </span>Appt.
                                </div> : ""
                            }
                        </div>
                    </div>
                ...
                <Col md={4} className="p-0  mt-4">
                    <div className="rd-card refund-client">
                        ...
                        <div className="rd-content">
                            ...
                            <div> <span
                                className="amt"> NPR {appointmentStatistics.refundInfo &&
                            appointmentStatistics.refundInfo.refundedAmount || 0}</span> from
                                <span
                                    className="apt"> {appointmentStatistics.refundInfo &&
                                appointmentStatistics.refundInfo.refundedCount || 0} </span>Appt.
                            </div>
                            ...
                            appointmentStatistics.refundInfo.followUpCount ?
                                <div className="follow-up"><i className="fa fa-tag"></i><span
                                    className="fl-label"> Follow-up </span> <span
                                    className="amt"> NPR {appointmentStatistics.refundInfo
                                && appointmentStatistics.refundInfo.followUpAmount || 0}</span> from<span
                                    className="apt"> {appointmentStatistics.refundInfo
                                && appointmentStatistics.refundInfo.followUpCount || 0} </span>Appt.
                                </div> : ""
                            }
                        </div>
                    </div>
