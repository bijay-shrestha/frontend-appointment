...
const newGet = (path, headers) => Axios.get(`${path}`, headers,{crossOrigin:true,crossDomain:true,withCredentials:true})
const newPost = (path, data, headers) => {
  console.log('data', headers)
  return Axios.post(`${path}`, data, {headers: {...headers}},{crossOrigin:true,crossDomain:true,withCredentials:true})
}
