...
class CHybridSelectWithImage extends PureComponent {
    ...
    handleOnChange = event => {
        event
            ...
            : this.props.onChange({
                target: {name: this.props.name, value: '', label: '', fileUri: ''}
            });
    };
...
CHybridSelectWithImage.defaultProps = {
...
CHybridSelectWithImage.propTypes = {
...
export default CHybridSelectWithImage;
