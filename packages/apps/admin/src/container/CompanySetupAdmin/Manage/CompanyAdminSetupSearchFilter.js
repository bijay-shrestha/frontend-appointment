...
class CompanyAdminSetupSearchFilter extends PureComponent {
  state = {
        ...
        {this.state.isSearchFormExpanded ? (
          ...
          <div id="advanced-search" className="advanced-search">
            <div className="search-header d-flex justify-content-between">
              <h5 className="title">Search Company Admins</h5>
              <div>
                <CButton
                  id="reset-form"
            ...
            <ul id="" className="search-filter-item">
              ...
              {searchParameters.metaInfo && (
                <li>
                  <OverlayTrigger
                    ...
                    overlay={props => (
                      <Tooltip {...props}>Company Admin Info</Tooltip>
                    )}
                  >
              ...
              {searchParameters.company && (
                <li>
                  ...
                  >
                    <Button id="light-search-filters" variant="secondary">
                      {searchParameters.company.label}
                    </Button>
                  </OverlayTrigger>
                </li>
              )}
              ...
              {searchParameters.profile && (
                <li>
                  <OverlayTrigger
                    ...
                    delay={{show: 250, hide: 400}}
                    overlay={props => (
                      <Tooltip {...props}>Admin Profile</Tooltip>
                    )}
                  >
                ...
                <li>
                  ...
                  >
                    <Button
                      ...
                      variant="secondary"
                    >
                      {searchParameters.genderCode.value === 'F'
                        ? 'Female'
                        : searchParameters.genderCode.value === 'M'
                        ? 'Male'
                        : 'Other'}
                    </Button>
                  </OverlayTrigger>
...
export default CompanyAdminSetupSearchFilter
