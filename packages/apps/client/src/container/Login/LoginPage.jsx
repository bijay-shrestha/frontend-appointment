...
class LoginPage extends React.PureComponent {
  onSubmitHandler = async user => {
    try {
      ...
      const userMenus = await this.props.fetchLoggedInAdminUserInfo('/api/v1/admin/info', {
        username: user.username
      })
...
export default ConnectHoc(LoginPage, ['loginReducers', 'userMenuReducers','DashboardFeaturesByAdminReducer'], {
  fetchUserMenus,
  signinUser,
  fetchLoggedInAdminUserInfo,
