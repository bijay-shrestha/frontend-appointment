...
export const fetchAppointmentQueueList = (
  path,
  paginationData,
  queueSearchData
) => async dispatch => {
  dispatch(DashboardDetailsActions.dashboardAppointmentQueueFetchingStart())
  try {
...
export const fetchDashboardRegisteredPatientListForClient = path => async dispatch => {
  dispatch(DashboardDetailsActions.dashboardRegisteredPatientsFetchingStart())
  try {
